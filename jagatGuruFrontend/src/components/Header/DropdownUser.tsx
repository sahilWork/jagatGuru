...
const DropdownUser = (props: {
  ...
  const [userData, setUserData] = useState<adminProps|null>(null);
    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      {dropdownOpen && (
        ...
        >
          ...
          <button onClick={props.onLogout} className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
            <LogoutIcon />
            Log Out
          </button>
        </div>
