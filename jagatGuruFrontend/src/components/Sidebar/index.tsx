...
import ChartIcon from '../svgIcons/ChartIcon';
import TablesIcon from '../svgIcons/TablesIcon';
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/agent"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === '/agent' && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <ProfileIcon />
                  Agent
              ...
              {userData && userData.role === 'Super Admin' && (
                <li>
                  <NavLink
                    to="/Super-Admin"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname === 'Super-Admin' && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <ProfileIcon />
                    Super Admin
